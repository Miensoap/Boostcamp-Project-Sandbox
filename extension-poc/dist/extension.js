...
async function sendDataToServer(activeTime, language) {
    const data = {
    ...
    try {
        await axios_1.default.post(SERVER_URL, data);
...
var asynckit = __webpack_require__(16);
var populate = __webpack_require__(26);
...
module.exports =
{
  parallel      : __webpack_require__(17),
  serial        : __webpack_require__(24),
  serialOrdered : __webpack_require__(25)
};
...
var iterate    = __webpack_require__(18)
  , initState  = __webpack_require__(22)
  , terminator = __webpack_require__(23)
  ;
...
var abort = __webpack_require__(21)
...
var serialOrdered = __webpack_require__(25);
